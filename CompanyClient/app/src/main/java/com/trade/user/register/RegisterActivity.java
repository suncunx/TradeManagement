package com.trade.user.register;
...
import com.trade.user.register.di.DaggerRegisterComponent;
import com.trade.user.register.di.RegisterModule;
import com.trade.user.register.mvp.RegisterPresenter;
import com.trade.user.register.mvp.RegisterView;
