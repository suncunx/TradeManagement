...
import com.trade.user.login.di.DaggerLoginComponent;
import com.trade.user.login.di.LoginModule;
import com.trade.user.login.model.LoginBean;
import com.trade.user.login.mvp.LoginPresenter;
import com.trade.user.login.mvp.LoginView;
...
public class LoginActivity extends BaseActivity<LoginView, LoginPresenter> implements LoginView {
    ...
    public class LoginClickListener {
        ...
        public void onLoginByPwd() { // 使用密码登录
            startActivity(LoginBlackActivity.getCallingIntent(LoginActivity.this));
        }
