...
import com.trade.R;
import com.trade.model.DeliverResultBean;
import com.trade.other.deliver.adapter.DeliverAdapter;
import com.trade.other.deliver.di.DaggerDeliverPresenterComponent;
import com.trade.other.deliver.di.DeliverPresenterModule;
import com.trade.other.deliver.model.DeliverService;
...
public class DeliverPresenterImpl extends BaseNovateRvPresenterImpl<DeliverView, DeliverService> implements DeliverPresenter, BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.RequestLoadMoreListener, View.OnClickListener {
    ...
    protected void initializeInjector(ApplicationComponent applicationComponent) {
        DaggerDeliverPresenterComponent.builder()
                .applicationComponent(applicationComponent)
                .deliverPresenterModule(new DeliverPresenterModule())
                .build()
                .inject(this);
    }
