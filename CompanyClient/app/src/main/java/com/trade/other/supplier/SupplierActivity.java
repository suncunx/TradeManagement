package com.trade.other.supplier;
...
import com.trade.BR;
import com.trade.R;
import com.trade.other.supplier.di.DaggerSupplierComponent;
import com.trade.other.supplier.di.SupplierModule;
import com.trade.other.supplier.mvp.SupplierPresenter;
import com.trade.other.supplier.mvp.SupplierView;
...
public class SupplierActivity extends BaseRvToolbarActivity<SwipeRefreshLayout, AdapterBean, SupplierView, SupplierPresenter> implements SupplierView {
    ...
    public void initializeInjector() {
        DaggerSupplierComponent.builder()
