package com.trade.other.deliver;
...
import com.trade.BR;
import com.trade.R;
import com.trade.other.deliver.di.DaggerDeliverComponent;
import com.trade.other.deliver.di.DeliverModule;
import com.trade.other.deliver.mvp.DeliverPresenter;
import com.trade.other.deliver.mvp.DeliverView;
...
public class DeliverActivity extends BaseRvToolbarActivity<SwipeRefreshLayout, AdapterBean, DeliverView, DeliverPresenter> implements DeliverView {
    ...
    public void initializeInjector() {
        DaggerDeliverComponent.builder()
