package com.trade.other.focus.news;
...
import com.trade.BR;
import com.trade.R;
import com.trade.other.focus.news.di.DaggerNewsFragmentComponent;
import com.trade.other.focus.news.di.NewsFragmentModule;
import com.trade.other.focus.news.mvp.NewsFragmentPresenter;
import com.trade.other.focus.news.mvp.NewsFragmentView;
...
public class NewsFragment extends BaseRvFragment<SwipeRefreshLayout, AdapterBean, NewsFragmentView, NewsFragmentPresenter> implements NewsFragmentView {
    ...
    public void initializeInjector() {
        DaggerNewsFragmentComponent.builder()
                .newsFragmentModule(new NewsFragmentModule())
                .build()
                .inject(this);
    }
