...
import com.trade.other.customer.adapter.CustomerAdapter;
import com.trade.other.customer.di.CustomerPresenterModule;
import com.trade.other.customer.di.DaggerCustomerPresenterComponent;
import com.trade.other.customer.model.CustomerService;
...
public class CustomerPresenterImpl extends BaseNovateRvPresenterImpl<CustomerView, CustomerService> implements CustomerPresenter, BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.RequestLoadMoreListener, View.OnClickListener {
    ...
    protected void initializeInjector(ApplicationComponent applicationComponent) {
        DaggerCustomerPresenterComponent.builder()
                .applicationComponent(applicationComponent)
                .customerPresenterModule(new CustomerPresenterModule())
                .build()
                .inject(this);
    }
