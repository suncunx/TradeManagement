...
import com.trade.DeliverBean;
import com.trade.home.detail.outBill.di.DaggerOutBillPresenterComponent;
import com.trade.home.detail.outBill.di.OutBillPresenterModule;
import com.trade.home.detail.outBill.model.OutBillService;
...
public class OutBillPresenterImpl extends BaseNovatePresenterImpl<OutBillView, OutBillService> implements OutBillPresenter {
    ...
    protected void initializeInjector(ApplicationComponent applicationComponent) {
        DaggerOutBillPresenterComponent.builder()
                .applicationComponent(applicationComponent)
                .outBillPresenterModule(new OutBillPresenterModule())
                .build()
                .inject(this);
    }
