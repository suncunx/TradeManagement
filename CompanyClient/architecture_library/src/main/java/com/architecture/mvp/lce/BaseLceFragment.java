...
public abstract class BaseLceFragment<CV extends View, M, V extends BaseLceView<M>, P extends MvpPresenter<V>> extends MvpLceFragment<CV, M, V, P> implements BaseLceView<M> {
